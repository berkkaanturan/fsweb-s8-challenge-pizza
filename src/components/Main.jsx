    ...
    <section className="nav-bottom">
      <nav>
        <div className="nav-item">
          <a href="">
            <img src="images/iteration-2-images/icons/1.svg" alt="" />Ramen</a>
        </div>
        <div className="nav-item">
          <a href="" className="active"
            ><img src="images/iteration-2-images/icons/2.svg" alt="" />Pizza</a
          >
        </div>
        <div className="nav-item">
          <a href=""
            ><img src="images/iteration-2-images/icons/3.svg" alt="" />Burger</a
          >
        </div>
        <div className="nav-item">
          <a href=""
            ><img src="images/iteration-2-images/icons/4.svg" alt="" />French
            Fries</a
          >
        </div>
        <div className="nav-item">
          <a href=""
            ><img src="images/iteration-2-images/icons/5.svg" alt="" />Fast
            food</a
          >
        </div>
        <div className="nav-item">
          <a href=""
            ><img src="images/iteration-2-images/icons/6.svg" alt="" />Soft
            drinks</a
          >
        </div>
      </nav>
